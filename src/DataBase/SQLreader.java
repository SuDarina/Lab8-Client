    ...
    public void createBase() throws SQLException {
        if (!isCreated()) {
            String command = "CREATE TABLE IF NOT EXISTS users(\n" +
                    ...
                    ");\n" +
                    "INSERT INTO users (id, login, password, online, color) VALUES (DEFAULT, 'Pavel', '202CB962AC59075B964B07152D234B70', 0, 0);\n" +
                    "INSERT INTO users (id, login, password, online, color) VALUES (DEFAULT, 'Egor', '81DC9BDB52D04DC20036DBD8313ED055', 0, 1);\n" +
                    "\n" +
